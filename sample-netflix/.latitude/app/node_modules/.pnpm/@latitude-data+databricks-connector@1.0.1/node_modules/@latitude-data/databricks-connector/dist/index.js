import { BaseConnector, ConnectionError } from '@latitude-data/base-connector';
import QueryResult, { DataType } from '@latitude-data/query_result';
import { DBSQLClient } from '@databricks/sql';

class DatabricksConnector extends BaseConnector {
    client;
    connectionOptions;
    isConnected = false;
    constructor(rootPath, connectionParams) {
        ...
        else if (connectionParams.oauthClientId &&
