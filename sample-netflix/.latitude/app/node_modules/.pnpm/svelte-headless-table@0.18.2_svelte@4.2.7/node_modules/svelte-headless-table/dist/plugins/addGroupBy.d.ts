...
export declare const getGroupedRows: <Item, Row extends BodyRow<Item, import("../types/TablePlugin.js").AnyPlugins>, GroupOn extends string | number = any>(rows: Row[], groupByIds: string[], columnOptions: Record<string, GroupByColumnOptions<Item, any, any, any>>, { repeatCellIds, aggregateCellIds, groupCellIds, allGroupByIds }: GetGroupedRowsProps) => Row[];
export declare const addGroupBy: <Item>({ initialGroupByIds, disableMultiGroup, isMultiGroupEvent, }?: GroupByConfig) => TablePlugin<Item, GroupByState, GroupByColumnOptions<Item, any, any, any>, GroupByPropSet>;
export {};
