export declare enum ChartLayerType {
    line = "line",
    bar = "bar",
    area = "area",
    scatter = "scatter",
...
export type EChartsSupportedType = ChartLayerType.line | ChartLayerType.bar | ChartLayerType.scatter | ChartLayerType.funnel | ChartLayerType.pie;
export type Dataset = {
    fields: string[];
    source: DBSource;
};
