...
export type EchartsCartesianSeriesOption<T extends ChartType> = T extends 'line' ? LineSeriesOption : T extends 'area' ? LineSeriesOption : T extends 'bar' ? BarSeriesOption : T extends 'scatter' ? ScatterSeriesOption : LineSeriesOption;
export {};
