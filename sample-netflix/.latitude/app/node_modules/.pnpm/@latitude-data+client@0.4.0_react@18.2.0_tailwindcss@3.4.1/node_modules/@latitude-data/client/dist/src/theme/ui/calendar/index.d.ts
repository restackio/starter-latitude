...
export declare const HEADER_ROW_CSS_CLASS = "flex";
export declare const BODY_ROW_CSS_CLASS = "mt-2 w-full";
...
export { cell, day, grid, gridBody, gridHead, gridRow, headCell, header, heading, months, nextButton, prevButton, };
