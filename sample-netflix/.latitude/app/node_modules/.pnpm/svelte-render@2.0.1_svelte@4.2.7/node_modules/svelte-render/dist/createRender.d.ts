...
export declare function createRender<TComponent extends SvelteComponent<Record<string, never>>>(component: Constructor<TComponent>): ComponentRenderConfig<TComponent>;
